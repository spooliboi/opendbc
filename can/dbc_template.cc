  ...
  {% for sig in sigs %}
    {
      ...
      {% elif checksum_type == "hkg_can_fd" and sig.name == "CHECKSUM" %}
      .type = SignalType::HKG_CAN_FD_CHECKSUM,
      {% elif checksum_type == "hkg_can_fd" and sig.name == "COUNTER" %}
      .type = SignalType::HKG_CAN_FD_COUNTER,
